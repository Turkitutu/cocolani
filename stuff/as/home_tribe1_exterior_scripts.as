...
//------------------------------------------------------------
//com.cocolani.scenes.home_tribe1_exterior

package com.cocolani.scenes
{
    import flash.display.MovieClip;

    public class home_tribe1_exterior extends homes_external 
    {

        public var exitpad3:MovieClip;
        public var background:MovieClip;
        public var exitpad1:MovieClip;
        public var walktopos4:MovieClip;
        public var startpos1:MovieClip;
        public var walktopos3:MovieClip;
        public var startpos2:MovieClip;
        public var walktopos2:MovieClip;
        public var startpos3:MovieClip;
        public var walktopos1:MovieClip;
        public var foreground:MovieClip;
        public var collide1:MovieClip;
        public var stump1:home_tribe1_exterior_mc_treestump;
        public var stump2:home_tribe1_exterior_mc_treestump;
        public var door1:home_tribe1_exterior_door_top;
        public var stump3:home_tribe1_exterior_mc_treestump;
        public var door2:home_tribe1_exterior_door_top;
        public var exitpad4:MovieClip;
        public var startpos4:MovieClip;
        public var door3:home_tribe1_exterior_door_top;
        public var exitpad2:MovieClip;

        public function home_tribe1_exterior()
        {
            this.stump3.myDir = 8;
            this.stump2.myDir = 5;
            this.stump1.myDir = 3;
...
//------------------------------------------------------------
//com.cocolani.scenes.homes_external
...
package com.cocolani.scenes
{
    ...
    public class homes_external extends scene 
    {

        internal var doorblockerCoord:* = [new Point(-205, 317), new Point(96, 247), new Point(395, 179)];
        internal var doorblockerRef:* = [];
        internal var exitScenes:* = [{
            "id":8,
            "name":"Jungle Centre"
        }, {
            "id":14,
        ...
        public function homes_external()
        {
            if (thisref.background.getChildByName("door1"))
            {
                setChildren(thisref.background, ["door1", "door2", "door3"]);
                thisref.background.door1.sceneObjId = 1;
                thisref.background.door2.sceneObjId = 2;
                thisref.background.door3.sceneObjId = 3;
            }
            else
            {
                thisref.door1.sceneObjId = 1;
                thisref.door2.sceneObjId = 2;
                thisref.door3.sceneObjId = 3;
                thisref.door1.setInteractive();
                thisref.door2.setInteractive();
                thisref.door3.setInteractive();
            };
            trace("home external.");
        }
        ...
        override public function optionResult(_arg_1:*, _arg_2:*):*
        {
            ...
            if (_arg_2 == 1)
            {
                if (_arg_1.state != 2)
                {
                    ...
                    _local_3.ext = "home";
                    _local_3.cmd = "door";
                    _local_3.id = ((int(((thisref.stage.getChildAt(0).mc_scene.loadHomeID - 1) / 3)) * 3) + _arg_1.sceneObjId);
            ...
            else
            {
                if (_arg_2 == 2)
                {
                    if (this.isDoorIdEgos(_arg_1.sceneObjId))
                    {
                        _local_3 = new Object();
                        _local_3.ext = "home";
                        _local_3.cmd = "door";
                ...
                else
                {
                    if (_arg_2 == 3)
                    {
                        _local_4 = (Number(_arg_1.name.substr(4, 1)) + 1);
                        _local_5 = roomSFSobj.getVariable("data").split("|");
                        _local_6 = _local_5[(_local_4 - 2)].split(",");
                        if (_local_6[0] == "1")
                        {
                            egoref.commandList.push({
                                "walkto":new Point(thisref[("walktopos" + _local_4)].x, thisref[("walktopos" + _local_4)].y),
                                "sendupdate":true,
                                "setListener":false,
                            ...
                            _local_7 = ((int(((thisref.stage.getChildAt(0).mc_scene.loadHomeID - 1) / 3)) * 3) + (_local_4 - 1));
                            egoref.commandList.push({
                                "loadHome":_local_7,
                                "fileName":"home_tribe1_interior.swf",
                                "inside":true
                            });
                        ...
                        {
                            rootref.showmsg(rootref.langObj.getText("hom14"));
                        };
                    }
                    else
                    {
        ...
        override public function roomObjClicked(_arg_1:*):*
        {
            ...
            if (((_arg_1.sceneObjId >= 1) && (_arg_1.sceneObjId <= 3)))
            {
                if (_local_2 > 80)
                {
                    if (this.isDoorIdEgos(_arg_1.sceneObjId))
                    {
                        if (_arg_1.currentFrame == 1)
                        {
                            rootref.mc_interface.feedback.revealmessage(langObj.getText("hom00"), "");
                        }
                        else
                        {
                            rootref.mc_interface.feedback.revealmessage(langObj.getText("hom01"), "");
                        };
                    }
                    else
                    {
                        if (_arg_1.currentFrame == 1)
                        {
                            rootref.mc_interface.feedback.revealmessage(langObj.getText("hom02"), "");
                        }
                        else
                        {
                            rootref.mc_interface.feedback.revealmessage(langObj.getText("hom03"), "");
                        };
                    };
                }
                else
        ...
        override public function getPlayerSceneEntryInstructions(_arg_1:*):*
        {
            ...
            var _local_7:*;
            var _local_8:*;
            var _local_2:* = _arg_1.sfsAV.getVariable("cr");
            if (_local_2)
            {
                _local_3 = rootref.sfs.getRoom(_local_2).getName();
            };
            if (((_local_3) && (_local_3.substr(0, 12) == "homeInterior")))
            {
                _local_4 = rootref.sfs.getRoom(_local_2).getVariable("tribeID");
                _local_5 = _arg_1.sfsAV.getVariable("lihom");
                if (((!(_local_4)) && (_local_3.indexOf("homeInterior") > -1)))
                {
                    _local_4 = _local_3.split("_")[2];
                    _local_4 = Number(_local_4.substring(2, _local_4.length));
                };
                _local_6 = roomSFSobj.getVariable("addr");
                _local_7 = roomSFSobj.getVariable("tribeID");
                if (((_local_4 == _local_7) && (int(((_local_5 - 1) / 3)) == Number(_local_6))))
                {
                    _local_8 = (Number((_local_5 - 1)) % 3);
                    if (getChildByName(("mask" + _local_8)))
                    {
                        _arg_1.setMasking(thisref[("mask" + (_local_8 + 1))]);
                    };
                    _arg_1.commandList.push({
                        "walkto":new Point(thisref[("startpos" + (_local_8 + 2))].x, thisref[("startpos" + (_local_8 + 2))].y),
                        "sendupdate":true,
                        "setListener":false,
                        "setUserControl":false
                    }, {
        ...
        override public function getStartPos(_arg_1:*):*
        {
            ...
            var _local_8:*;
            var _local_9:*;
            var _local_2:* = _arg_1.getVariable("cr");
            if (_local_2)
            {
                _local_3 = rootref.sfs.getRoom(_local_2).getName();
            };
            if (((_local_3) && (_local_3.substr(0, 12) == "homeInterior")))
            {
                ...
                _local_5 = _arg_1.getVariable("lihom");
                _local_6 = roomSFSobj.getVariable("addr");
                _local_7 = roomSFSobj.getVariable("tribeID");
                if (((_local_4 == _local_7) && (int(((_local_5 - 1) / 3)) == Number(_local_6))))
                {
                    _local_8 = (Number((_local_5 - 1)) % 3);
                    _local_9 = new Point(thisref[("walktopos" + (_local_8 + 2))].x, thisref[("walktopos" + (_local_8 + 2))].y);
                }
                else
                {
                    _local_9 = new Point(thisref.startpos1.x, thisref.startpos1.y);
                };
            }
            else
            {
        ...
        {
            var _local_3:*;
            trace(((_arg_1.sfsAV.getName() + "Walked over exit ") + _arg_2));
            if (_arg_2 == 1)
            {
                _arg_1.commandList.push({
                    ...
                    "loadRoom":this.exitScenes[(rootref.currentTribe - 1)].id,
                    "roomName":this.exitScenes[(rootref.currentTribe - 1)].name
                });
                _arg_1.executeNextCommand();
            }
            else
            {
                if (getChildByName(("mask" + (_arg_2 - 1))))
                {
                    _arg_1.setMasking(thisref[("mask" + (_arg_2 - 1))]);
                };
                _arg_1.commandList.push({
                    "walkto":new Point(thisref[("walktopos" + _arg_2)].x, thisref[("walktopos" + _arg_2)].y),
                    "sendupdate":true,
                    "setListener":false,
                    "setUserControl":false,
                    "fadeout":10,
                ...
                _local_3 = ((int(((thisref.stage.getChildAt(0).mc_scene.loadHomeID - 1) / 3)) * 3) + (_arg_2 - 1));
                _arg_1.commandList.push({
                    "loadHome":_local_3,
                    "fileName":"home_tribe1_interior.swf",
                    "inside":true
        ...
        {
            rootref.mc_interface.audio.fadeOut();
        }

        public function isDoorIdEgos(_arg_1:*):*
        {
            if ((((int(((thisref.stage.getChildAt(0).mc_scene.loadHomeID - 1) / 3)) == int(((thisref.stage.getChildAt(0).myHomeAddr - 1) / 3))) && ((Number((int(((thisref.stage.getChildAt(0).mc_scene.loadHomeID - 1) / 3)) * 3)) + _arg_1) == Number(thisref.stage.getChildAt(0).myHomeAddr))) && (thisref.stage.getChildAt(0).currentTribe == thisref.stage.getChildAt(0).myTribe)))
            {
                return (true);
            };
            return (false);
        ...
        public function setDoors(_arg_1:*=false):*
        {
            ...
            while (_local_3 < 4)
            {
                _local_4 = _local_2[(_local_3 - 1)].split(",");
                if (thisref.background[("door" + _local_3)])
                {
                    _local_5 = thisref.background[("door" + _local_3)];
                }
                else
                {
                    _local_5 = thisref[("door" + _local_3)];
                };
                _local_5.state = _local_4[0];
                if (_local_4[0] == "1")
                {
                    if (((_local_5.currentLabel == "closed") && (!(_arg_1))))
                    {
                        rootref.mc_interface.audio.playSound("sfx_dooropen", 0, 1, true);
                    };
                    _local_5.gotoAndStop("open");
                    if (this.doorblockerRef[(_local_3 - 1)])
                    {
                        thisref.collide1.removeChild(this.doorblockerRef[(_local_3 - 1)]);
                        this.doorblockerRef[(_local_3 - 1)] = undefined;
                    };
                }
                else
                {
                    if (((_local_5.currentLabel == "open") && (!(_arg_1))))
                    {
                        rootref.mc_interface.audio.playSound("sfx_doorclose", 0, 1, true);
                    };
                    _local_5.gotoAndStop("closed");
                    if (!this.doorblockerRef[(_local_3 - 1)])
                    {
                        _local_6 = getDefinitionByName(("mc_door_blocker_tb" + rootref.currentTribe));
                        this.doorblockerRef[(_local_3 - 1)] = thisref.collide1.addChild(new (_local_6)());
                        this.doorblockerRef[(_local_3 - 1)].x = this.doorblockerCoord[(_local_3 - 1)].x;
                        this.doorblockerRef[(_local_3 - 1)].y = this.doorblockerCoord[(_local_3 - 1)].y;
                    };
                };
                _local_3++;
            };
        ...
        public function setHomeLabels():*
        {
            ...
            while (_local_2 < 4)
            {
                _local_3 = _local_1[(_local_2 - 1)].split(",");
                if (((_local_3[2]) && (!(_local_3[2] == "null"))))
                {
                    thisref.background[("homename" + _local_2)].label.text = _local_3[2];
                }
                else
                {
                    thisref.background[("homename" + _local_2)].label.text = langObj.getText("com14");
                };
                _local_2++;
            };
        }
        ...
        override public function initroomfn():*
        {
            ...
            rootref.mc_interface.audio.sequencer(_local_1);
        }
...
//------------------------------------------------------------
//com.cocolani.sceneInteractiveObject
...
package com.cocolani
{
    ...
    public dynamic class sceneInteractiveObject extends sceneObject 
    {

        internal var selectedFilter:* = new GlowFilter(2280652, 1, 8, 8, 2, 1, false, false);
        internal var unselectedFilters:*;
        public var sceneObjId:* = 0;

        public function sceneInteractiveObject()
        {
        ...
        public function init(_arg_1:Event):*
        {
            ...
            if (stageRef.getChildByName("mc_scene"))
            {
                sceneRef = stageRef.mc_scene.sceneRef;
            };
        }

        override public function mousecatcher(_arg_1:MouseEvent):*
        {
            if ((((!(stageRef.getChildByName("mc_scene"))) || (distanceToActive == -1)) || (stageRef.mc_scene.sceneRef.getDistanceToObject(thisref) <= distanceToActive)))
            {
                buttonMode = true;
                if (_arg_1.type == "mouseOver")
                {
                    thisref.filters = [selectFilter2];
                }
                else
                {
                    if (_arg_1.type == "click")
                    {
                        if (stageRef.mc_interface.speechHandlerRef)
                        {
                            stageRef.mc_interface.speechHandlerRef.shutdown();
                        };
                        stageRef.mc_scene.sceneRef.roomObjClicked(thisref);
            ...
            else
            {
                ...
                if (((_arg_1.type == "click") && (stageRef.getChildByName("mc_scene"))))
                {
                    stageRef.mc_scene.gotclick(_arg_1);
                };
            };
        }
...
package com.cocolani
{
    ...
    public class sceneObjectSit extends sceneObject 
    {
        ...
        public var standpos1:MovieClip;
        public var bgd:MovieClip;
        public var sitpos1:MovieClip;
        public var yline:MovieClip;
        public var seatinglist:* = [];
        public var seatID:*;
        public var myDir:* = 1;
...
//------------------------------------------------------------
//home_tribe1_exterior_door_top

package 
{
    import com.cocolani.sceneObjectNosit;

    public dynamic class home_tribe1_exterior_door_top extends sceneObjectNosit 
    {
...
//------------------------------------------------------------
//home_tribe1_exterior_door_yeknom

package 
{
    import com.cocolani.sceneInteractiveObject;

    public dynamic class home_tribe1_exterior_door_yeknom extends sceneInteractiveObject 
    {
...
//------------------------------------------------------------
//home_tribe1_exterior_mc_treestump

package 
{
    import com.cocolani.sceneObjectSit;

    public dynamic class home_tribe1_exterior_mc_treestump extends sceneObjectSit 
    {
...
package 
{
    ...
    public dynamic class mc_door_blocker_tb1 extends MovieClip 
    {
